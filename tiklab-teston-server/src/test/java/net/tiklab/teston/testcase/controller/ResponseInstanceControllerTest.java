...
public class ResponseInstanceControllerTest {

    private static Logger logger = LoggerFactory.getLogger(ResponseInstanceControllerTest.class);
    ...
    public void test01ForSaveResponseInstance() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(responseInstance);

        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/responseInstance/createResponseInstance")
    ...
    public void test02ForUpdateResponseInstance(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/responseInstance/updateResponseInstance")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindResponseInstance() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/responseInstance/findResponseInstance")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllResponseInstance() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/responseInstance/findAllResponseInstance")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteResponseInstance(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/responseInstance/deleteResponseInstance")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
