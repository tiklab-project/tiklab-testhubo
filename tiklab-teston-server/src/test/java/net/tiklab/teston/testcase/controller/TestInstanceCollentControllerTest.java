...
public class TestInstanceCollentControllerTest {

    private static Logger logger = LoggerFactory.getLogger(TestInstanceCollentControllerTest.class);
    ...
    public void test01ForSaveTestInstanceCollent() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(testInstanceCollent);

        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/testInstanceCollent/createTestInstanceCollent")
    ...
    public void test02ForUpdateTestInstanceCollent(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/testInstanceCollent/updateTestInstanceCollent")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindTestInstanceCollent() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/testInstanceCollent/findTestInstanceCollent")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllTestInstanceCollent() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/testInstanceCollent/findAllTestInstanceCollent")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteTestInstanceCollent(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/testInstanceCollent/deleteTestInstanceCollent")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
