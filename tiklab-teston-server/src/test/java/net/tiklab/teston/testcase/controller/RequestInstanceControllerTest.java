...
public class RequestInstanceControllerTest {

    private static Logger logger = LoggerFactory.getLogger(RequestInstanceControllerTest.class);
    ...
    public void test01ForSaveRequestInstance() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(requestInstance);

        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/requestInstance/createRequestInstance")
    ...
    public void test02ForUpdateRequestInstance(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/requestInstance/updateRequestInstance")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindRequestInstance() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/requestInstance/findRequestInstance")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllRequestInstance() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/requestInstance/findAllRequestInstance")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteRequestInstance(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/requestInstance/deleteRequestInstance")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
