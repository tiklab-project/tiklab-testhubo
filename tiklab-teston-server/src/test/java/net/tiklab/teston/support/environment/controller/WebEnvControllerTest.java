...
import net.tiklab.teston.support.environment.model.WebEnv;
...
public class WebEnvControllerTest {

    private static Logger logger = LoggerFactory.getLogger(WebEnvControllerTest.class);
    ...
    public void test01ForSaveWebEnv() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(webEnv));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/webEnv/createWebEnv")
