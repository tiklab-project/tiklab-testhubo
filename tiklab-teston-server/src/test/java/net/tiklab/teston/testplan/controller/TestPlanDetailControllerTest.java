...
public class TestPlanDetailControllerTest {

    private static Logger logger = LoggerFactory.getLogger(TestPlanDetailControllerTest.class);
    ...
    public void test01ForSaveTestPlanDetail() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(testPlanDetail);

        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/testPlanDetail/createTestPlanDetail")
    ...
    public void test02ForUpdateTestPlanDetail(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/testPlanDetail/updateTestPlanDetail")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindTestPlanDetail() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/testPlanDetail/findTestPlanDetail")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllTestPlanDetail() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/testPlanDetail/findAllTestPlanDetail")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteTestPlanDetail(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/testPlanDetail/deleteTestPlanDetail")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
