...
public class TestPlanInstanceControllerTest {

    private static Logger logger = LoggerFactory.getLogger(TestPlanInstanceControllerTest.class);
    ...
    public void test01ForSaveTestPlanInstance() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(testPlanInstance));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/testPlanInstance/createTestPlanInstance")
    ...
    public void test02ForUpdateTestPlanInstance(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/testPlanInstance/updateTestPlanInstance")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindTestPlanInstance() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/testPlanInstance/findTestPlanInstance")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllTestPlanInstance() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/testPlanInstance/findAllTestPlanInstance")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteTestPlanInstance(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/testPlanInstance/deleteTestPlanInstance")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
