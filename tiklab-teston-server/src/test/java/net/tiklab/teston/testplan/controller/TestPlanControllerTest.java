...
public class TestPlanControllerTest {
    ...
    private static Logger logger = LoggerFactory.getLogger(TestPlanControllerTest.class);
    ...
    public void test01ForSaveTestPlan() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(testPlan);

        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/testPlan/createTestPlan")
