...
public class TestPlanCaseInstanceBindControllerTest {

    private static Logger logger = LoggerFactory.getLogger(TestPlanCaseInstanceBindControllerTest.class);
    ...
    public void test01ForSaveTestPlanCaseInstanceBind() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(testPlanCaseInstanceBind));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/testPlanCaseInstanceBind/createTestPlanCaseInstanceBind")
    ...
    public void test02ForUpdateTestPlanCaseInstanceBind(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/testPlanCaseInstanceBind/updateTestPlanCaseInstanceBind")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindTestPlanCaseInstanceBind() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/testPlanCaseInstanceBind/findTestPlanCaseInstanceBind")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllTestPlanCaseInstanceBind() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/testPlanCaseInstanceBind/findAllTestPlanCaseInstanceBind")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteTestPlanCaseInstanceBind(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/testPlanCaseInstanceBind/deleteTestPlanCaseInstanceBind")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
