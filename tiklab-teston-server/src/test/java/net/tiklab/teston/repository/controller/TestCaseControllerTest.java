...
public class TestCaseControllerTest {
    ...
    private static Logger logger = LoggerFactory.getLogger(TestCaseControllerTest.class);
    ...
    public void test01ForSaveTestCase() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(testCase);
