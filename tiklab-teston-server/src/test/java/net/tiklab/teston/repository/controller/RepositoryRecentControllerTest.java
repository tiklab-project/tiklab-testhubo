...
public class RepositoryRecentControllerTest {

    private static Logger logger = LoggerFactory.getLogger(RepositoryRecentControllerTest.class);
    ...
    public void test01ForSaveRepositoryRecent() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(repositoryRecent));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/repositoryRecent/createRepositoryRecent")
    ...
    public void test02ForUpdateRepositoryRecent(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/repositoryRecent/updateRepositoryRecent")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindRepositoryRecent() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/repositoryRecent/findRepositoryRecent")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllRepositoryRecent() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/repositoryRecent/findAllRepositoryRecent")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteRepositoryRecent(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/repositoryRecent/deleteRepositoryRecent")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
