package net.tiklab.teston.integration.actiontype.controller;
...
public class ActionTypeControllerTest {
    ...
    private static Logger logger = LoggerFactory.getLogger(ActionTypeControllerTest.class);
    ...
    public void test01ForSaveActionType() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(actionType);

        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/actionType/createActionType")
    ...
    public void test02ForUpdateActionType(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/actionType/updateActionType")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindActionType() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/actionType/findActionType")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllActionType() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/actionType/findAllActionType")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteActionType(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/actionType/deleteActionType")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
