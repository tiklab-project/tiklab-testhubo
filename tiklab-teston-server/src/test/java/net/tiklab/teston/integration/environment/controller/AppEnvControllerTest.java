...
public class AppEnvControllerTest {

    private static Logger logger = LoggerFactory.getLogger(AppEnvControllerTest.class);
    ...
    public void test01ForSaveAppEnv() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(appEnv));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/appEnv/createAppEnv")
