package net.tiklab.teston.apptest.scenetest.controller;
...
public class AppSceneInstanceStepControllerTest {

    private static Logger logger = LoggerFactory.getLogger(AppSceneInstanceStepControllerTest.class);
    ...
    public void test01ForSaveAppSceneInstanceStep() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(appSceneInstanceStep));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/appSceneInstanceStep/createAppSceneInstanceStep")
    ...
    public void test02ForUpdateAppSceneInstanceStep(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/appSceneInstanceStep/updateAppSceneInstanceStep")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindAppSceneInstanceStep() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/appSceneInstanceStep/findAppSceneInstanceStep")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllAppSceneInstanceStep() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/appSceneInstanceStep/findAllAppSceneInstanceStep")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteAppSceneInstanceStep(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/appSceneInstanceStep/deleteAppSceneInstanceStep")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
