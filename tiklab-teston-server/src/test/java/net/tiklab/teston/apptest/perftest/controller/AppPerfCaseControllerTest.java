...
public class AppPerfCaseControllerTest {

    private static Logger logger = LoggerFactory.getLogger(AppPerfCaseControllerTest.class);
    ...
    public void test01ForSaveAppPerfCase() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(appPerfCase));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/appPerfCase/createAppPerfCase")
    ...
    public void test02ForUpdateAppPerfCase(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/appPerfCase/updateAppPerfCase")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindAppPerfCase() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/appPerfCase/findAppPerfCase")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllAppPerfCase() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/appPerfCase/findAllAppPerfCase")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteAppPerfCase(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/appPerfCase/deleteAppPerfCase")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
