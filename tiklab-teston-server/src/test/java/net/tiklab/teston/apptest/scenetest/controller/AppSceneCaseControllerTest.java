...
public class AppSceneCaseControllerTest {

    private static Logger logger = LoggerFactory.getLogger(AppSceneCaseControllerTest.class);
    ...
    public void test01ForSaveAppSceneCase() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(appSceneCase));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/appSceneCase/createAppSceneCase")
    ...
    public void test02ForUpdateAppSceneCase(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/appSceneCase/updateAppSceneCase")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindAppSceneCase() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/appSceneCase/findAppSceneCase")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllAppSceneCase() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/appSceneCase/findAllAppSceneCase")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteAppSceneCase(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/appSceneCase/deleteAppSceneCase")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
