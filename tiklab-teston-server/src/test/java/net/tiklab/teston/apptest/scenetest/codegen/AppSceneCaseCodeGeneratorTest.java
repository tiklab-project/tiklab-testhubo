...
import net.tiklab.teston.test.appscene.cases.entity.AppSceneCaseEntity;
...
public class AppSceneCaseCodeGeneratorTest extends CodeGeneratorTemplate {
    ...
    protected CodeGeneratorConfig getCodeGeneratorConfig() {
        ...
        config.setEntity(AppSceneCaseEntity.class);
        config.setPkg("net.tiklab.teston.apptest.scenetest");
        config.setModel("AppSceneCase");
        return config;
    }
