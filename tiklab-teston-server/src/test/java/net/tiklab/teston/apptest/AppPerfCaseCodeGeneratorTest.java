...
import net.tiklab.teston.test.app.perf.cases.entity.AppPerfCaseEntity;
...
public class AppPerfCaseCodeGeneratorTest extends CodeGeneratorTemplate {
    ...
    protected CodeGeneratorConfig getCodeGeneratorConfig() {
        ...
        config.setEntity(AppPerfCaseEntity.class);
        config.setPkg("net.tiklab.teston.apptest.perftest");
        config.setModel("AppPerfCase");
        return config;
    }
