...
public class AppSceneStepControllerTest {

    private static Logger logger = LoggerFactory.getLogger(AppSceneStepControllerTest.class);
    ...
    public void test01ForSaveAppSceneStep() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(appSceneStep));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/appSceneStep/createAppSceneStep")
    ...
    public void test02ForUpdateAppSceneStep(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/appSceneStep/updateAppSceneStep")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindAppSceneStep() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/appSceneStep/findAppSceneStep")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllAppSceneStep() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/appSceneStep/findAllAppSceneStep")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteAppSceneStep(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/appSceneStep/deleteAppSceneStep")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
