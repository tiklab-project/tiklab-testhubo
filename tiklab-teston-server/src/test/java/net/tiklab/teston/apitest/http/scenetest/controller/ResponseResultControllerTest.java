...
import net.tiklab.teston.test.api.http.unit.cases.model.ResponseResult;
...
public class ResponseResultControllerTest {
    ...
    private static Logger logger = LoggerFactory.getLogger(ResponseResultControllerTest.class);
    ...
    public void test01ForSaveResponseResult() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(responseResult);

        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/responseResult/createResponseResult")
    ...
    public void test02ForUpdateResponseResult(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/responseResult/updateResponseResult")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindResponseResult() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/responseResult/findResponseResult")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllResponseResult() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/responseResult/findAllResponseResult")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteResponseResult(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/responseResult/deleteResponseResult")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
