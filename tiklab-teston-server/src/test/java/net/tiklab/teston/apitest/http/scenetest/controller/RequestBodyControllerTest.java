...
public class RequestBodyControllerTest {
    ...
    private static Logger logger = LoggerFactory.getLogger(RequestBodyControllerTest.class);
    ...
    public void test01ForSaveRequestBody() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(requestBody);
    ...
    public void test02ForUpdateRequestBody(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/requestBody/updateRequestBody")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindRequestBody() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/requestBody/findRequestBody")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllRequestBody() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/requestBody/findAllRequestBody")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteRequestBody(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/requestBody/deleteRequestBody")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
