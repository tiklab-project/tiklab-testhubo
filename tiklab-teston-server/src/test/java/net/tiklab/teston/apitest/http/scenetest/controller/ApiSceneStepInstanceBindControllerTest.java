...
public class ApiSceneStepInstanceBindControllerTest {

    private static Logger logger = LoggerFactory.getLogger(ApiSceneStepInstanceBindControllerTest.class);
    ...
    public void test01ForSaveApiSceneStepInstanceBind() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(apiSceneStepInstanceBind));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/apiSceneStepInstanceBind/createApiSceneStepInstanceBind")
    ...
    public void test02ForUpdateApiSceneStepInstanceBind(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/apiSceneStepInstanceBind/updateApiSceneStepInstanceBind")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindApiSceneStepInstanceBind() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/apiSceneStepInstanceBind/findApiSceneStepInstanceBind")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllApiSceneStepInstanceBind() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/apiSceneStepInstanceBind/findAllApiSceneStepInstanceBind")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteApiSceneStepInstanceBind(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/apiSceneStepInstanceBind/deleteApiSceneStepInstanceBind")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
