...
import net.tiklab.teston.test.api.http.scene.cases.entity.ApiSceneStepEntity;
...
public class ApiSceneStepCodeGeneratorTest extends CodeGeneratorTemplate {
    ...
    protected CodeGeneratorConfig getCodeGeneratorConfig() {
        ...
        config.setEntity(ApiSceneStepEntity.class);
        config.setPkg("net.tiklab.teston.apitest.http.scenetest");
        config.setModel("ApiSceneStep");
        return config;
    }
