...
public class ApiUnitInstanceBindControllerTest {

    private static Logger logger = LoggerFactory.getLogger(ApiUnitInstanceBindControllerTest.class);
    ...
    public void test01ForSaveApiUnitInstanceBind() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(apiUnitInstanceBind));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/apiUnitInstanceBind/createApiUnitInstanceBind")
    ...
    public void test02ForUpdateApiUnitInstanceBind(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/apiUnitInstanceBind/updateApiUnitInstanceBind")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindApiUnitInstanceBind() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/apiUnitInstanceBind/findApiUnitInstanceBind")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllApiUnitInstanceBind() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/apiUnitInstanceBind/findAllApiUnitInstanceBind")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteApiUnitInstanceBind(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/apiUnitInstanceBind/deleteApiUnitInstanceBind")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
