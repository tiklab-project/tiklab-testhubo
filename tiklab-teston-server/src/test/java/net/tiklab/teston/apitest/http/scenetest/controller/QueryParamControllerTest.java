...
import net.tiklab.teston.apitest.http.unittest.model.QueryParam;
...
public class QueryParamControllerTest {
    ...
    private static Logger logger = LoggerFactory.getLogger(QueryParamControllerTest.class);
    ...
    public void test01ForSaveQueryParam() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(queryParam);

        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/queryParam/createQueryParam")
    ...
    public void test02ForUpdateQueryParam(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/queryParam/updateQueryParam")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindQueryParam() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/queryParam/findQueryParam")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllQueryParam() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/queryParam/findAllQueryParam")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteQueryParam(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/queryParam/deleteQueryParam")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
