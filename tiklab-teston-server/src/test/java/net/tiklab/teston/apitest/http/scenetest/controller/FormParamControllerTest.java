...
public class FormParamControllerTest {
    ...
    private static Logger logger = LoggerFactory.getLogger(FormParamControllerTest.class);
    ...
    public void test01ForSaveFormParam() {
        ...
        MultiValueMap<String, String> multiValueMap = MapUtils.toMultiMap(formParam);

        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/formParam/createFormParam")
    ...
    public void test02ForUpdateFormParam(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/formParam/updateFormParam")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test04ForFindAllFormParam() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/formParam/findAllFormParam")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteFormParam(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/formParam/deleteFormParam")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
