package net.tiklab.teston.webtest.scenetest.controller;
...
public class WebSceneInstanceStepControllerTest {

    private static Logger logger = LoggerFactory.getLogger(WebSceneInstanceStepControllerTest.class);
    ...
    public void test01ForSaveWebSceneInstanceStep() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(webSceneInstanceStep));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/webSceneInstanceStep/createWebSceneInstanceStep")
    ...
    public void test02ForUpdateWebSceneInstanceStep(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/webSceneInstanceStep/updateWebSceneInstanceStep")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindWebSceneInstanceStep() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/webSceneInstanceStep/findWebSceneInstanceStep")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllWebSceneInstanceStep() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/webSceneInstanceStep/findAllWebSceneInstanceStep")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteWebSceneInstanceStep(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/webSceneInstanceStep/deleteWebSceneInstanceStep")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
