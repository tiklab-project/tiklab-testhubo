package net.tiklab.teston.webtest.perftest.controller;
...
public class WebPerfStepControllerTest {

    private static Logger logger = LoggerFactory.getLogger(WebPerfStepControllerTest.class);
    ...
    public void test01ForSaveWebPerfStep() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(webPerfStep));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/webPerfStep/createWebPerfStep")
    ...
    public void test02ForUpdateWebPerfStep(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/webPerfStep/updateWebPerfStep")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindWebPerfStep() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/webPerfStep/findWebPerfStep")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllWebPerfStep() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/webPerfStep/findAllWebPerfStep")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteWebPerfStep(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/webPerfStep/deleteWebPerfStep")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
