...
public class WebSceneStepControllerTest {

    private static Logger logger = LoggerFactory.getLogger(WebSceneStepControllerTest.class);
    ...
    public void test01ForSaveWebSceneStep() {
        ...
        Map paramMap  = JSONObject.parseObject(JSONObject.toJSONString(webSceneStep));
        MultiValueMap<String, String> multiValueMap = new LinkedMultiValueMap<>();
        multiValueMap.setAll(paramMap);
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/webSceneStep/createWebSceneStep")
    ...
    public void test02ForUpdateWebSceneStep(){
        ...
        try {
            MvcResult mvcResult = mockMvc.perform(
                                post("/webSceneStep/updateWebSceneStep")
                                .params(multiValueMap)
                                .accept(MediaType.APPLICATION_JSON)
                                .contentType(MediaType.APPLICATION_JSON)
                    )
    ...
    public void test03ForFindWebSceneStep() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/webSceneStep/findWebSceneStep")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
    ...
    public void test04ForFindAllWebSceneStep() {
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/webSceneStep/findAllWebSceneStep")
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
                    .andExpect(status().isOk())
    ...
    public void test05ForDeleteWebSceneStep(){
        try {
            MvcResult mvcResult = mockMvc.perform(
                    post("/webSceneStep/deleteWebSceneStep")
                            .param("id",id)
                            .accept(MediaType.APPLICATION_JSON)
                            .contentType(MediaType.APPLICATION_JSON)
            )
