package net.tiklab.teston.test.api.http.scene.cases.service;

import net.tiklab.beans.BeanMapper;
import net.tiklab.core.page.Pagination;
import net.tiklab.core.page.PaginationBuilder;
import net.tiklab.join.JoinTemplate;
import net.tiklab.teston.test.api.http.scene.cases.entity.ApiSceneCaseEntity;
import net.tiklab.teston.test.api.http.scene.cases.dao.ApiSceneCaseDao;
import net.tiklab.teston.test.api.http.scene.cases.model.ApiSceneCase;
import net.tiklab.teston.test.api.http.scene.cases.model.ApiSceneCaseQuery;
