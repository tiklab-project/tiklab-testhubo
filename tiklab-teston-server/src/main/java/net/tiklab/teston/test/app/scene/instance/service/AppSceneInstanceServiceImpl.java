package net.tiklab.teston.test.app.scene.instance.service;

import net.tiklab.beans.BeanMapper;
import net.tiklab.core.page.Pagination;
import net.tiklab.core.page.PaginationBuilder;
import net.tiklab.join.JoinTemplate;
import net.tiklab.teston.test.app.scene.instance.dao.AppSceneInstanceDao;
import net.tiklab.teston.test.app.scene.instance.entity.AppSceneInstanceEntity;
