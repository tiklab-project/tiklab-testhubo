...
import net.tiklab.teston.test.apix.http.scene.instance.entity.ApiSceneStepInstanceBindEntity;
...
import net.tiklab.teston.test.apix.http.scene.instance.dao.ApiSceneStepInstanceBindDao;
