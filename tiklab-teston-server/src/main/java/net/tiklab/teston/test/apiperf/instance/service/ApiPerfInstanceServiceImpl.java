package net.tiklab.teston.test.apiperf.instance.service;

import net.tiklab.core.page.PaginationBuilder;
import net.tiklab.teston.test.apiperf.instance.dao.ApiPerfInstanceDao;
import net.tiklab.teston.test.apiperf.instance.entity.ApiPerfInstanceEntity;
