...
INSERT INTO teston_action_type values   ('click1234567','click','WEB','点击对象'),
                                        ...
                                        ('mouselkclick','mouselkclickhold','WEB','模拟鼠标左键点击后不释放'),
                                        ...
                                        ('appselectbyv','selectbyvisibletext','APP','通过下拉框文本进行选择'),
                                        ...
                                        ('applongpress','longpresselement','APP','长按指定页面对象'),
                                        ('appalertacce','alertaccept','APP','弹出框点确认'),
                                        ('appalertcanc','alertcancel','APP','弹出框点取消'),
                                        ('appalertgett','alertgettext','APP','获取弹出框text'),
                                        ('appagetconte','getcontexthandles','APP','获取当前所有上下文句柄'),
                                        ('appexjsob123','exjsob','APP','针对对象执行js脚本'),
                                        ('appandroidke','androidkeycode','APP','安卓模拟手机按键'),
                                        ('appgotoconte','gotocontext','APP','跳转指定的context'),
                                        ('appgettitle1','gettitle','APP','获取当前页标题'),
                                        ('appgetcontex','getcontext','APP','获取当前页context'),
                                        ('appswipepage','swipepageup','APP','页面向上滑动(参数：持续时间(秒),滚动次数)'),
                                        ('appswipepage','swipepagedown','APP','页面向下滑动(参数：持续时间（秒）,滚动次数)'),
                                        ('appswipepage','swipepageleft','APP','页面向左滑动(参数：持续时间（秒）,滚动次数)'),
                                        ('appswipepage','swipepageright','APP','页面向右滑动(参数：持续时间（秒）,滚动次数)'),
                                        ...
                                        ('apphideKeybo','hideKeyboard','APP','隐藏手机系统键盘'),
                                        ('appruncase12','runcase','APP','调用指定接口用例'),
                                        ('appexecuteAd','executeAdb','APP','执行安卓adb命令'),
                                        ('appswipeup12','swipeup','APP','手指向上滑动(参数：持续时间（秒），滚动次数)'),
                                        ('appswipedown','swipedown','APP','手指向下滑动(参数：持续时间秒，滚动次数)'),
                                        ('appswipeleft','swipeleft','APP','手指向左滑动(参数：持续时间（秒），滚动次数)'),
                                        ('appswiperigh','swiperight','APP','手指向右滑动(参数：持续时间(秒)，滚动次数)'),
                                        ('appimplicitl','implicitlyWait','APP','隐式等待(参数：秒)');
