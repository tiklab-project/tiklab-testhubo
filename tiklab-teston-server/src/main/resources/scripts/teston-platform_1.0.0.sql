...
INSERT INTO  pcs_mec_message_notice  ( id ,  message_type_id ,  type ,  bgroup ,  message_send_type_id ) VALUES ('MSG_NOTICEID', 'RP_MS_TYPE', 1, 'teston', 'dingding,email,qywechat,site');
