...
import io.thoughtware.testhubo.common.TestHuboUnit;
import io.thoughtware.testhubo.repository.model.*;
import io.thoughtware.rpc.annotation.Exporter;
import io.thoughtware.testhubo.category.model.Category;
import io.thoughtware.testhubo.common.MessageTemplateConstant;
import io.thoughtware.testhubo.repository.dao.RepositoryDao;
import io.thoughtware.testhubo.repository.entity.RepositoryEntity;
import io.thoughtware.testhubo.support.environment.service.AppEnvService;
import io.thoughtware.testhubo.support.environment.service.WebEnvService;
import io.thoughtware.testhubo.test.test.service.TestCaseService;
import io.thoughtware.testhubo.testplan.cases.service.TestPlanService;
...
import io.thoughtware.testhubo.support.environment.model.ApiEnv;
import io.thoughtware.testhubo.support.environment.service.ApiEnvService;
...
public class RepositoryServiceImpl implements RepositoryService {
    ...
    public String createRepository(@NotNull @Valid Repository repository) {
        ...
        //日志
        testHuboUnit.log(MessageTemplateConstant.LOG_TYPE_CREATE_ID,"repository",map);
        //消息
    ...
    public void updateRepository(@NotNull @Valid Repository repository) {
        ...
        map.put("link","/repository/detail/${repositoryId}");
        testHuboUnit.log(MessageTemplateConstant.LOG_TYPE_UPDATE_ID,"repository",map);
    }
