package io.tiklab.testhubo.category.service;
...
import io.tiklab.testhubo.category.dao.CategoryDao;
import io.tiklab.testhubo.category.entity.CategoryEntity;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    public int findCategoryNum(String repositoryId) {
        int categoryNum = categoryDao.findCategoryNum(repositoryId);
        return categoryNum;
    }
