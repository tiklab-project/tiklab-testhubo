package net.tiklab.teston.app.perf.instance.service;

import net.tiklab.beans.BeanMapper;
import net.tiklab.core.page.Pagination;
import net.tiklab.core.page.PaginationBuilder;
import net.tiklab.join.JoinTemplate;
import net.tiklab.teston.app.perf.instance.dao.AppPerfInstanceDao;
import net.tiklab.teston.app.perf.instance.entity.AppPerfInstanceEntity;
