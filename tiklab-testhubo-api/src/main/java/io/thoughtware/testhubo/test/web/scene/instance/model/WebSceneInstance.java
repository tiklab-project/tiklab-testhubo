package io.thoughtware.testhubo.test.web.scene.instance.model;
 ...
 */
@ApiModel
@Mapper(targetName = "io.thoughtware.testhubo.web.scene.instance.entity.WebSceneInstanceEntity")
