package io.thoughtware.testhubo.test.common.stepassert.model;
 ...
 */
@ApiModel
@Mapper(targetName = "io.thoughtware.testhubo.test.common.stepassert.entity.StepAssertCommonEntity")
@Join
