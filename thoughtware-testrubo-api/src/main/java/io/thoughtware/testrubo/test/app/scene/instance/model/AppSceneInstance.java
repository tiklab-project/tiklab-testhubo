package io.thoughtware.testrubo.test.app.scene.instance.model;
 ...
 */
@ApiModel
@Mapper(targetName = "io.thoughtware.testrubo.app.scene.instance.entity.AppSceneInstanceEntity")
