package io.thoughtware.testrubo.test.apix.http.perf.cases.model;
 ...
 */
@ApiModel
@Mapper(targetName = "io.thoughtware.testrubo.test.apix.http.perf.cases.entity.ApiPerfStepEntity")
@Join
