package io.thoughtware.testrubo.test.common.stepassert.model;
 ...
 */
@ApiModel
@Mapper(targetName = "io.thoughtware.testrubo.test.common.stepassert.entity.StepAssertCommonEntity")
@Join
