package io.thoughtware.testrubo.config;
...
import io.thoughtware.testrubo.EnableTestRuboServer;
...
@EnableTestRuboServer
@ComponentScan(value = "io.thoughtware.testrubo")
public class TestRuboAutoConfiguration {
