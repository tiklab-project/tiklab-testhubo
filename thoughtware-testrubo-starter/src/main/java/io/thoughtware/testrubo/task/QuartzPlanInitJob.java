...
import io.thoughtware.testrubo.testplan.quartz.service.QuartzTimePlanService;
    ...
    public void run(){
        try {
            ...
            for (QuartzTimePlan quartzTimePlan : quartzTimePlanList) {
                ...
                String time = TestRuboUnit.weekTime(quartzTimePlan.getCron());
                Date date = TestRuboUnit.StringChengeDate(time);
