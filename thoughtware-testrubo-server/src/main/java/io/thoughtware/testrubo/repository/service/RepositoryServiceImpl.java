...
import io.thoughtware.testrubo.repository.model.*;
import io.thoughtware.rpc.annotation.Exporter;
import io.thoughtware.testrubo.category.model.Category;
import io.thoughtware.testrubo.common.MessageTemplateConstant;
import io.thoughtware.testrubo.repository.dao.RepositoryDao;
import io.thoughtware.testrubo.repository.entity.RepositoryEntity;
import io.thoughtware.testrubo.support.environment.service.AppEnvService;
import io.thoughtware.testrubo.support.environment.service.WebEnvService;
...
import io.thoughtware.testrubo.support.environment.service.ApiEnvService;
...
public class RepositoryServiceImpl implements RepositoryService {
    ...
    public String createRepository(@NotNull @Valid Repository repository) {
        ...
        //日志
        testRuboUnit.log(MessageTemplateConstant.LOG_TYPE_CREATE_ID,"repository",map);
        //消息
        testRuboUnit.message(map);
    ...
    public void updateRepository(@NotNull @Valid Repository repository) {
        ...
        map.put("link","/repository/detail/${repositoryId}");
        testRuboUnit.log(MessageTemplateConstant.LOG_TYPE_UPDATE_ID,"repository",map);
    }
