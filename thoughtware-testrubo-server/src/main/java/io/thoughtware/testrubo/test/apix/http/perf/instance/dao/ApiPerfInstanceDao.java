package io.thoughtware.testrubo.test.apix.http.perf.instance.dao;

import io.thoughtware.testrubo.test.apix.http.perf.instance.entity.ApiPerfInstanceEntity;
