...
import io.thoughtware.testhubo.testplan.quartz.config.SchedulerConfig;
import io.thoughtware.testhubo.testplan.quartz.model.QuartzPlan;
import io.thoughtware.testhubo.testplan.quartz.model.QuartzTimePlan;
import io.thoughtware.testhubo.testplan.quartz.service.QuartzPlanService;
import io.thoughtware.testhubo.testplan.quartz.service.QuartzTimePlanService;
    ...
    public void run(){
        try {
            ...
            for (QuartzTimePlan quartzTimePlan : quartzTimePlanList) {
                ...
                String time = TestHuboUnit.weekTime(quartzTimePlan.getCron());
                Date date = TestHuboUnit.StringChengeDate(time);
